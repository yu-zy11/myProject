...
#ifndef PINOCCHIO_INTERFACE_PINOCCHIO_SRBD_H_
#define PINOCCHIO_INTERFACE_PINOCCHIO_SRBD_H_
...
class PinocchioSRBD {
 ...
 public:
  PinocchioSRBD(std::shared<Model> model_ptr, std::shared<Data> data_ptr,
