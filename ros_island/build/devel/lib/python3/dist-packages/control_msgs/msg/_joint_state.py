...
"""autogenerated by genpy from control_msgs/joint_state.msg. Do not edit."""
import codecs
import sys
...
class joint_state(genpy.Message):
  _md5sum = "cee320b1b25101ce84cadf5dd27b382f"
  _type = "control_msgs/joint_state"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """#topic:'motion/joint/state'
Header header
...
string frame_id
"""
  __slots__ = ['header','joint_position','joint_velocity','torque']
  _slot_types = ['std_msgs/Header','float32[12]','float32[12]','float32[12]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,joint_position,joint_velocity,torque
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_12f().pack(*self.torque))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.torque = _get_struct_12f().unpack(str[start:end])
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.torque = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=12)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
