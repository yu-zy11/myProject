...
#ifndef __MujocoState_hpp__
#define __MujocoState_hpp__
...
int MujocoState::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int MujocoState::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int MujocoState::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t MujocoState::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* MujocoState::getTypeName()
{
    return "MujocoState";
}

int MujocoState::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->imu_omega[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->imu_quat[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->body_position[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->body_velocity[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int MujocoState::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->imu_omega[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->imu_quat[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->body_position[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->body_velocity[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int MujocoState::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t MujocoState::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xb9325c5b17cea306LL;
