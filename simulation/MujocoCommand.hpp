...
#ifndef __MujocoCommand_hpp__
#define __MujocoCommand_hpp__
...
int MujocoCommand::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int MujocoCommand::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int MujocoCommand::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t MujocoCommand::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* MujocoCommand::getTypeName()
{
    return "MujocoCommand";
}

int MujocoCommand::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int MujocoCommand::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int MujocoCommand::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t MujocoCommand::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x80d6a48a21130a32LL;
